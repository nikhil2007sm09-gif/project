...
import { Heart, Share2, ShoppingCart, ChevronLeft, ChevronRight, Star, Filter, X } from 'lucide-react'
...
const Products = () => {
  ...
  const fetchCategories = async () => {
    try {
      ...
      setCategories([
        { _id: '1', name: 'Electronics', color: '#FF6B6B' },
        { _id: '2', name: 'Fashion', color: '#4ECDC4' },
