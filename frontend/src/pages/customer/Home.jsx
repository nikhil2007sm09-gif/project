...
import { ShoppingBag, Truck, Shield, Star, TrendingUp, Award, Users, ArrowRight, Sparkles, Zap, Gift, Crown, Tag, Clock, CheckCircle, ChevronLeft, ChevronRight } from 'lucide-react'
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    // Set initial items per slide based on screen size
  ...
  const nextTestimonial = () => {
    const maxSlides = Math.ceil(testimonials.length / itemsPerSlide) - 1
    setTestimonialsCurrentSlide((prev) => 
  ...
  const offers = [
    {
      ...
      badge: "Limited Time",
      color: "bg-gradient-to-r from-orange-500 to-black text-white"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-gradient-to-r from-orange-400 via-orange-500 to-black text-white text-sm font-bold px-6 py-2 rounded-full mb-6 shadow-md hover:shadow-orange-500/30 transition-all duration-300">
              <Sparkles className="w-4 h-4 mr-2" />
              DISCOVER YOUR STYLE
            </div>
            <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-center">

              <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-400 via-orange-500 to-[#3F322C] tracking-wide">
                Shop by Style
              </span>

              <div className="h-1 w-20 mx-auto mt-3 rounded-full bg-gradient-to-r from-orange-400 to-[#3F322C]"></div>
          ...
          <div className="text-center mt-12">
            <Link
              to="/products"
              className="inline-flex items-center bg-gradient-to-r from-orange-400 via-orange-500 to-[#3F322C] text-white px-10 py-5 rounded-full font-black text-lg shadow-lg hover:shadow-orange-500/30 transition-all duration-300 hover:scale-105"
            >
      ...
      <section className="py-24 bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            {/* Badge */}
            <div className="inline-flex items-center bg-gradient-to-r from-orange-400 to-[#3F322C] text-white rounded-full px-5 py-2 mb-4 shadow-md">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4 text-center">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-400 via-orange-500 to-[#3F322C]">
                Loved by Thousands
              </span>
            </h2>
...
<div className="relative max-w-7xl mx-auto">
  {testimonials.length > 0 && (
    <>
      ...
      <button
        ...
        className="absolute left-2 md:left-0 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full p-3 md:p-4 shadow-lg hover:scale-110 transition"
      >
      ...
      <button
        ...
        className="absolute right-2 md:right-0 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full p-3 md:p-4 shadow-lg hover:scale-110 transition"
      >
      ...
      <div className="overflow-hidden">
        ...
        >
          {Array.from({
            ...
            <div
              key={slideIndex}
              className="min-w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 px-2 md:px-4"
            >
              {testimonials
                .slice(
                ...
                .map((testimonial, index) => (
                  <div
                    key={index}
                    className="bg-white rounded-3xl p-5 shadow-xl hover:shadow-2xl transition hover:-translate-y-1 border border-gray-100"
                  >
                    {/* User */}
                    <div className="flex items-center mb-4">
                      <div className="w-12 h-12 bg-[#3F322C] rounded-full flex items-center justify-center text-white font-bold mr-3 overflow-hidden">
                        {testimonial.image ? (
                          <img
          ...
          {/* <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto">
            <div className="group bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-purple-100">
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-[#3F322C] rounded-full flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 transition-transform">
                  <Users className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
                </div>
                <div className="text-4xl sm:text-5xl font-black mb-2 bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-[#3F322C]">
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 text-gray-800 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center bg-gradient-to-r from-orange-400 via-orange-500 to-[#3F322C] rounded-full px-4 sm:px-6 py-2 sm:py-3 mb-6 sm:mb-8 shadow-lg hover:shadow-orange-500/30 transition-all duration-300">
              <Gift className="w-4 h-4 sm:w-5 sm:h-5 mr-2 animate-bounce text-white" />
              <span className="font-bold text-sm sm:text-base text-white tracking-wide">
                Special Offer • Limited Time Only
              </span>
            </div>

            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 leading-tight text-center">

              <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-400 via-orange-500 to-[#3F322C] tracking-wide">
                Ready to Upgrade Your Wardrobe?
              </span>

              <div className="h-1 w-24 mx-auto mt-3 rounded-full bg-gradient-to-r from-orange-400 to-[#3F322C]"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-10 sm:mb-12 px-4">
              <Link
                to="/register"
                className="group relative bg-gradient-to-r from-orange-400 via-orange-500 to-[#3F322C] text-white px-6 sm:px-8 md:px-10 py-3.5 sm:py-4 md:py-5 rounded-full font-black text-base sm:text-lg shadow-lg hover:shadow-orange-500/30 transition-all duration-300 inline-flex items-center justify-center overflow-hidden"
              >
                <span className="relative z-10 flex items-center">
                  Create Free Account
                  <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-2 transition-transform" />
                ...
                {/* Hover overlay */}
                <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-[#2d2420] opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </Link>
              <Link
                to="/products"
                className="group bg-white border-2 border-[#45342B] text-[#45342B] px-6 sm:px-8 md:px-10 py-3.5 sm:py-4 md:py-5 rounded-full font-black text-base sm:text-lg hover:border-[#45342B] transition-all duration-300 inline-flex items-center justify-center shadow-lg"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-3xl mx-auto px-4">
              <div className="bg-white/80 backdrop-blur-md rounded-2xl p-4 sm:p-6 border border-purple-100 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                <CheckCircle className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-2 sm:mb-3 text-[#45342B]" />
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-flex items-center bg-gradient-to-r from-orange-400 via-orange-500 to-[#3F322C] text-white text-sm font-bold px-5 py-2 rounded-full mb-4 shadow-lg hover:shadow-orange-500/30 transition-all duration-300 tracking-wide">
                ...
                >
                  <summary className="flex items-center justify-between p-6 cursor-pointer list-none">
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0 w-10 h-10 bg-[#45342B] rounded-full flex items-center justify-center text-white font-bold shadow-lg">
                        💡
                      </div>
                      <h3 className="font-bold text-lg text-gray-800 group-hover:text-[#45342B] transition-colors">
                        {faq.question}
                      </h3>
                    </div>
                    <svg
  ...
  transition-all duration-300 hover:scale-105 overflow-hidden"
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-[#2b221d] opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </Link>
            </div>
          </div>
        </div>
  ...
  <div className="container mx-auto px-4">
    <div className="max-w-5xl mx-auto">
      ...
      <div className="relative bg-gradient-to-r from-orange-400 via-orange-500 to-[#3F322C] rounded-3xl p-10 md:p-16 text-white shadow-2xl overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          {/* Badge */}
          <div className="inline-flex items-center bg-white/20 backdrop-blur-md rounded-full px-6 py-2 mb-6 border border-white/30 shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto mb-8">
            ...
            <input
              ...
              className="flex-1 px-6 py-4 rounded-full text-gray-900 font-medium focus:outline-none focus:ring-4 focus:ring-orange-300 shadow-lg"
            />

            <button className="bg-black text-white px-10 py-4 rounded-full font-black hover:bg-[#2b221d] transition-all duration-300 whitespace-nowrap shadow-lg hover:shadow-xl hover:scale-105">
              Subscribe Now
            </button>
