...
const AffiliateLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setError('')
    try {
      const result = await login(formData.email, formData.password, 'affiliate')
      console.log('Affiliate login result:', result)
          ...
          <div className="relative h-64 md:h-auto">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              <div className="inline-flex items-center gap-2 mb-3 bg-white/20 backdrop-blur-md px-4 py-2 rounded-full border border-white/30 shadow-lg">
                ...
                <span className="text-sm font-bold">Affiliate Portal</span>
              </div>
              <h2 className="text-3xl font-black mb-2 drop-shadow-lg">Earn with Us</h2>
              <p className="text-base text-white/90 drop-shadow">
                Track your referrals and maximize your earnings
              </p>
            </div>
          </div>

          {/* Right Side - Login Form */}
          <div className="p-6 md:p-8 flex flex-col justify-center bg-gradient-to-br from-white to-green-50/30">
            <div className="mb-6">
              ...
              <h1 className="text-2xl md:text-3xl font-black text-gray-800 mb-1">Affiliate Login</h1>
              <p className="text-sm text-gray-600">Access your affiliate dashboard</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border-2 border-gray-200 bg-white px-3 py-2.5 text-sm text-gray-800 outline-none placeholder:text-gray-400 focus:border-green-400 focus:ring-4 focus:ring-green-100 transition-all"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-3 text-sm font-bold text-white shadow-lg hover:from-green-700 hover:to-emerald-700 hover:shadow-xl transition-all transform hover:scale-[1.02]"
              >
                Login to Dashboard
