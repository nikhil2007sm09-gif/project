...
// duration = Math.max(5000, Math.min(12000, distance * 8))
//       startTime = Date.now()
//       startPos = { ...position }
...
//         className="fixed bottom-5 left-5 z-50 w-16 h-16 bg-gradient-to-br from-orange-400 via-yellow-400 to-black rounded-full shadow-2xl flex items-center justify-center hover:scale-110 transition-transform duration-200 animate-bounce"
...
//             <div className="bg-gradient-to-r from-orange-500 via-black-500 to-yellow-500 text-white rounded-2xl shadow-2xl px-5 py-3 relative animate-float">
//               <p className="text-sm font-bold whitespace-nowrap drop-shadow-lg">
//                 {message}
//               </p>
//               <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-8 border-r-8 border-t-8 border-transparent border-t-black-500"></div>
//             </div>
//           </div>
//         )}
...
//               <div className="absolute w-2 h-2 bg-black-400 rounded-full animate-sparkle-2" 
...
//               <div className="absolute w-1.5 h-1.5 bg-yellow-300 rounded-full animate-sparkle-4" 
//                    style={{ bottom: '30%', right: '30%' }}></div>
//             </div>

//             <div className="absolute inset-0 bg-gradient-to-r from-orange-400/30 via-yellow-400/30 to-black-400/30 rounded-full blur-2xl animate-pulse-slow"></div>
//           </div>
...
//               className="w-9 h-9 bg-gradient-to-r from-orange-500 to-yellow-500 text-white rounded-full shadow-xl flex items-center justify-center text-sm font-bold hover:scale-110 transition-all hover:shadow-2xl"
